...
def process_nds_servicio(data):
    ...
    if 'Answered Calls' in data.columns and 'Abandoned Calls' in data.columns:
        ...
        plt.close(fig1)
        buf1.seek(0)
        charts['calls_chart'] = base64.b64encode(buf1.getvalue()).decode()
        buf1.close()
    ...
    if 'Index' in data.columns:
        ...
        plt.close(fig2)
        buf2.seek(0)
        charts['service_level_chart'] = base64.b64encode(buf2.getvalue()).decode()
        buf2.close()
    ...
    if 'Waiting Time (AVG)' in data.columns:
        ...
        plt.close(fig3)
        buf3.seek(0)
        charts['service_vs_waiting_chart'] = base64.b64encode(buf3.getvalue()).decode()
        buf3.close()
    ...
    if 'Talk Duration (AVG)' in data.columns:
        ...
        plt.close(fig4)
        buf4.seek(0)
        charts['talk_duration_chart'] = base64.b64encode(buf4.getvalue()).decode()
        buf4.close()
        """
    # 1. Gráfico de Barras: Llamadas Contestadas vs Abandonadas
    if 'Answered Calls' in data.columns and 'Abandoned Calls' in data.columns:
...
def process_nps_agente(data):
    ...
    if 'Topic' in data_valid.columns:
        ...
        plt.close(fig1)
        buf1.seek(0)
        charts['pie_chart'] = base64.b64encode(buf1.getvalue()).decode()
        buf1.close()
    ...
    if 'Topic' in data_valid.columns:
        ...
        plt.close(fig2)
        buf2.seek(0)
        charts['topic_chart'] = base64.b64encode(buf2.getvalue()).decode()
        buf2.close()
    ...
    if 'Speed of answer in seconds' in data_valid.columns:
        ...
        plt.close(fig3)
        buf3.seek(0)
        charts['speed_chart'] = base64.b64encode(buf3.getvalue()).decode()
        buf3.close()
    ...
    if 'AvgTalkDuration' in data_valid.columns:
        ...
        plt.close(fig4)
        buf4.seek(0)
        charts['duration_chart'] = base64.b64encode(buf4.getvalue()).decode()
        buf4.close()
    ...
    if 'Agent' in data_valid.columns:
        ...
        plt.close(fig5)
        buf5.seek(0)
        charts['agent_chart'] = base64.b64encode(buf5.getvalue()).decode()
        buf5.close()
        """
    # 1. Gráfico de Pastel: Distribución de Promotores, Pasivos y Detractores
    if 'Topic' in data_valid.columns:
